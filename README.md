...
A native macOS terminal multiplexer built on [libghostty](https://github.com/ghostty-org/ghostty). Sessions in a sidebar, splits and tabs, a bell-driven notification feed, and Ghostty-quality rendering — without tmux's complexity.

**[batty.sstools.co](https://batty.sstools.co)**
...
- **Layout picker** — apply a preset pane layout with Cmd-Shift-L
